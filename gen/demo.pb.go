...
type User struct {
	...
	Sex           User_Sex               `protobuf:"varint,2,opt,name=sex,proto3,enum=demo.User_Sex" json:"sex,omitempty"`
...
const file_demo_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"demo.proto\x12\x04demo\"\x80\x01\n" +
	"\x04User\x12\x12\n" +
	...
	"\x05error\x18\x01 \x01(\tR\x05error2\xf5\x01\n" +
	"\x04Auth\x126\n" +
	...
	"\aGetUser\x12\x14.demo.GetUserRequest\x1a\x15.demo.GetUserResponse\x12?\n" +
	"\n" +
	"DeleteUser\x12\x17.demo.DeleteUserRequest\x1a\x18.demo.DeleteUserResponseB\x16Z\x14prac_grpc/protos/genb\x06proto3"
...
var file_demo_proto_goTypes = []any{
	...
	(*DeleteUserRequest)(nil),  // 8: demo.DeleteUserRequest
	(*DeleteUserResponse)(nil), // 9: demo.DeleteUserResponse
}
var file_demo_proto_depIdxs = []int32{
	...
	2, // 3: demo.Auth.AddUser:input_type -> demo.AddUserRequest
	4, // 4: demo.Auth.ListUsers:input_type -> demo.ListUsersRequest
	6, // 5: demo.Auth.GetUser:input_type -> demo.GetUserRequest
	8, // 6: demo.Auth.DeleteUser:input_type -> demo.DeleteUserRequest
	3, // 7: demo.Auth.AddUser:output_type -> demo.AddUserResponse
	5, // 8: demo.Auth.ListUsers:output_type -> demo.ListUsersResponse
	7, // 9: demo.Auth.GetUser:output_type -> demo.GetUserResponse
	9, // 10: demo.Auth.DeleteUser:output_type -> demo.DeleteUserResponse
